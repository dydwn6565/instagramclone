          ...
          <div className="app-and-website">
            ...
            {selectedItem === "active" ? (
              <div className="app-and-website-contents">
                <div>
                  This is the app and website that you connected to your
                  Instagram
                </div>
                <div>
            ...
            {selectedItem === "expired" ? (
              <div className="app-and-website-contents">
                ...
                <div>
                  but have not been used in the last 90 days. This app and
                  website no
                </div>
                <div>
                ...
                <div>
                  email address) if you choose to share it when you log in to
                  your
                </div>
                <div>Instagram account</div>
                <div className="app-and-website-extra-info">
                  None of the apps that have access to your Instagram account
                  have expired
                </div>
              </div>
            ) : (
            ...
            {selectedItem === "deleted" ? (
              <div className="app-and-website-contents">
                <div>
                  This is an app and website that you are no longer linked to
                  your
                </div>
                <div>
                  Instagram account. This app and website no longer have access
                  to your
                </div>
                <div>
                ...
                <div>
                  you log in to your Instagram account. You can request the app
                  to
                </div>
                <div>
                  delete your information. To request deletion, review the
                  details and
                </div>
                <div>
                  contact information specified in the app's privacy policy.
                  User ID may
                </div>
