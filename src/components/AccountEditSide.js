        ...
        <Box sx={{ width: "100%", maxWidth: 360, bgcolor: "background.paper" }}>
          <List component="nav" aria-label="secondary mailbox folder">
            <ListItemButton
              ...
              onClick={(event) => {handleListItemClick(event, 2); accountEditor();}}
            ...
            <ListItemButton
              ...
              onClick={(event) => {handleListItemClick(event, 3); changePassword();}}
            >
              <ListItemText primary="Change password" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 4}
              onClick={(event) => {handleListItemClick(event, 4); appAndWebSite()}}
            >
              <ListItemText primary="App and Web site" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 5}
              onClick={(event) => {handleListItemClick(event, 3); emailAlarm()}}
            >
              <ListItemText primary="Email Alarm" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 6}
              onClick={(event) => {handleListItemClick(event, 6); pushAlarm()}}
            >
              <ListItemText primary="Push Alarm" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 7}
              onClick={(event) => {handleListItemClick(event, 7); manageContactNumber()}}
            >
              <ListItemText primary="Manage Contact Number" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 8}
              onClick={(event) => {handleListItemClick(event, 8); privateInfoandSecurity()}}
            >
              <ListItemText primary="Private Info and Security" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 9}
              onClick={(event) => {handleListItemClick(event, 9);supervision()}}
            >
              <ListItemText primary="Supervision" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 10}
              onClick={(event) => {handleListItemClick(event, 10); loginActivity()}}
            >
              <ListItemText primary="Login Activity" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 11}
              onClick={(event) => {handleListItemClick(event, 11); emailFromInstagrm();}}
            >
              <ListItemText primary="E-mail from Instagram" />
            </ListItemButton>
            <ListItemButton
              selected={selectedIndex === 12}
              onClick={(event) => {handleListItemClick(event, 12); help();}}
            >
