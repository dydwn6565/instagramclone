...
function ProfileTitle() {
    ...
    const redirectToEditProfile =()=> window.location.href="/account/edit"
  return (
    <>
      <div className="profile-title">
        ...
        <div>
          ...
          <span><BrightnessLowRoundedIcon/></span>
        </div>
        <div><span>Board  0</span><span>Follower 31 </span><span>Follow  43</span></div>
